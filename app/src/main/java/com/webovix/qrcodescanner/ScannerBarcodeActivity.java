                    ...
                    txtBarcodeValue.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (barcodes.valueAt(0).email != null) {
                                ...
                                isEmail = true;
                                btnAction.setText("Launching the email");
                            } else {
                                isEmail = false;
                                btnAction.setText("Launching URL");
                            ...
                            if (intentData.length() > 0) {
                                if (isEmail)
                                    startActivity(new Intent(ScannerBarcodeActivity.this, EmailActivity.class).putExtra("email_address", intentData));
                                else {
